...
export default function ProfilePage({ onLogout }: ProfileUserProps) {
  ...
  const fetchProfile = useCallback(async () => {
    ...
    try {
      ...
      catch { throw new Error("Server returned non-JSON response. Check PHP error logs."); }
  ...
  function handleSave(e: React.FormEvent) {
    ...
    fetch(`${API_BASE}/update_profile`, { method: "POST", headers: { "Content-Type": "application/x-www-form-urlencoded" }, body, credentials: "include" })
      .then(r => r.json())
      .then((res: { status: string; message?: string }) => {
    ...
    <>
      ...
      <style>{`
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        /* ── Match ProfileAdmin: lock html/body/root to viewport, no outer scroll ── */
        ...
        .profile-avatar-fallback { width:110px; height:110px; border-radius:50%; border:3px solid #bfdbfe; object-fit:cover; display:block; }
        ...
        .ta-form-control {
          ...
          background:#fff; transition:border-color 0.15s, box-shadow 0.15s; display:block;
        }
        ...
        .toast-msg {
          ...
          z-index:9999; box-shadow:0 4px 16px rgba(26,86,219,0.25);
            ...
            <div className="profile-card">
              ...
              >
                {avatarSrc
                  ...
                  : <div className="profile-avatar-fallback"><i className="fas fa-user" /></div>
                }
              ...
              {apiLoading
                ...
                : (
                  <>
                    ...
                    <div className="profile-handle">@{activeUsername || "..."}</div>
                  </>
                )
              }
                  ...
                  <form onSubmit={handleSave}>
                    ...
                    <div style={{ display:"flex", gap:10, flexWrap:"wrap" }}>
                      ...
                      <button
                        ...
                        onClick={() => { setEditOpen(false); setForm({ ...displayed }); }}
                      >
                        Cancel
                      </button>
                    </div>
